        ...
        <div className="flex flex-wrap gap-2 justify-center max-w-lg items-center mx-auto">
          {categories.map((category) => (
            <Button
              ...
              size="sm"
              className={cn(
                "rounded-full bg-black text-white hover:bg-[#DEFF4E] hover:text-black transition-all duration-300",
          ...
          <Button
            variant="outline"
            size="sm"
            className="rounded-full bg-[#DEFF4E] text-black hover:bg-[#DEFF4E]/80 transition-all duration-300"
          >
            + View more
          </Button>
        </div>
