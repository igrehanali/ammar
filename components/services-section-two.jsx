...
export default function ServicesSectionTwo() {
  ...
  return (
    <section className="bg-gradient-to-b from-black  via-[#BDDD3F] to-[#BDDD3F] border border-none border-b rounded-b-[2rem]">
        ...
        <div className="space-y-6 ">
          ...
          <div className="grid lg:grid-cols-2 sm:grid-rows-2  gap-5 md:gap-6 ">
            {services.map((service, index) => (
              ...
              >
                <div className="bg-[#0A0A09] relative   rounded-[1.7rem]  lg:min-h-[14rem] md:h-[10rem] h-[10rem]  mx-auto hover:bg-white hover:border-gray-100/10 hover:text-black  hover:scale-[1.02] hover:shadow-lg group">
